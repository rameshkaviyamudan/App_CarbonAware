...
public class M extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        valueTextView1 = findViewById(R.id.personalcarevalueTextView);
        valueTextView2 = findViewById(R.id.exercisevalueTextView);
        valueTextView3 = findViewById(R.id.officevalueTextView);
        valueTextView4 = findViewById(R.id.housecleaningvalueTextView);
        ...
        saveButton = findViewById(R.id.msaveButton);
        ...
        boolean mcalculationsDone = sharedmsavePreferences.getBoolean("calculationsDone", false);

        // Check if the calculations have already been done
        if (mcalculationsDone) {
    ...
    private double calculateCarbonFootprint() {
        // Calculate the carbon footprint based on the hours used for miscellaneous items
        // Assign a carbon footprint value to each item and calculate the total

        double carbonFootprint = 0.0;

        // Assign carbon footprint values based on the hours used for each item
        carbonFootprint += value1 * 0.5; // Example carbon footprint value for Personal Care
        carbonFootprint += value2 * 2.0; // Example carbon footprint value for Exercise Equipment
        carbonFootprint += value3 * 1.0; // Example carbon footprint value for Office Equipment
        carbonFootprint += value4 * 1.5; // Example carbon footprint value for Household Cleaning
    ...
    private void showConfirmationDialog() {
        ...
        confirmationMessage.append("Personal Care: ").append(value1).append(" Hours").append("\n");
        confirmationMessage.append("Exercise Equipment: ").append(value2).append(" Hours").append("\n");
        confirmationMessage.append("Office Equipment: ").append(value3).append(" Hours").append("\n");
        confirmationMessage.append("Household Cleaning: ").append(value4).append(" Hours").append("\n");
    ...
    private void saveData() {
        ...
        meditor.putBoolean("calculationsDone", true);
        meditor.apply();
        ...
        int cardIdentifier = 6; // Change this to the appropriate identifier for the Lighting card (1 in this case)
